      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body mt-3">
            <a href="form-create-spk.php" class="btn btn-primary btn-md p-2"><i class="bi bi-plus-circle"></i> Buat SPK Reguler</a>
            <a href="form-create-spk-ecat.php" class="btn btn-success btn-md p-2"><i class="bi bi-plus-circle"></i> Buat SPK E-cat</a>
          </div>
        </div>
        <div class="card">
          <div class="card-body mt-3">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="belum-diproses-tab-pane" role="tabpanel" aria-labelledby="belum-diproses-tab" tabindex="0">  
                  <div class="card-header">
                    <div class="row">
                      <div class="col-sm-10 text-dark"><a class="text-primary">SPK/001/1/2023</a> / <a>PO-001</a> / <a><i class="bi bi-clock"></i> 01 Jan 2023, 08.30 WIB</a></div>
                      <div class="col-sm-2"><a class="btn btn-warning">Belum Diproses <i class="bi bi-info-circle"></i></a></div>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="row">
